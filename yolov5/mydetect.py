...
def run(
    ...
    base_folder = f"{mylabels_path}/{input_file_path.stem}"
    ...
    save_dir = f"{base_folder}/video_output/obj_detect"
    if os.path.exists(save_dir):
        import shutil
        shutil.rmtree(save_dir, ignore_errors=True)
    os.mkdir(save_dir)
    save_path = f"{save_dir}/{input_file_path.name}"
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        # txt_path = f"./myfolder/mylabels/{p.stem}_{i}.txt"
        txt_path = f"{base_folder}/mylabels/{p.stem}_{i}.txt"
        # print(txt_path)
            ...
            with open(txt_path, 'r') as f:
                ...
                for line in lines:
                    ...
                    if save_conf:
                        ...
                        cls, a, b, c, d = line.split(" ")
                    
                    xyxy = [int(a), int(b), int(c), int(d)]
                    conf = float(conf)
                    # print(f"[debug] test_{i}.txt: {cls} {a} {b} {c} {d} {conf}")
